...
import com.example.myapplication.Chat_module.SignupDemo_quickblox;
...
public class Clients_SignUpActivity extends AppCompatActivity {
    ...
    public static final String TAG = "Clients_SignUpActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clients_signup);
//        signinusing = getIntent().getAction();
        initvalue();
    ...
    public void createaccount(View view) {
        ...
        String signuppwd = pwd.getText().toString().trim();
        ...
        Log.d(TAG, "createaccount: date name= " + name + " signupemail = "
                + signupemail + " signuppwd= " + signuppwd + " mobile= " + mobileno);
        if (isvalidate(name, signupemail, signuppwd, confpwd, mobileno)) {
            if (InternetAccess.isOnline(this)) {
                String role = ConstantString.CLIENT_LOGIN.toString();
                    ...
                    try {
                        ...
                        if (!jsonObject.getBoolean(ConstantString.IS_ERROR)) {
                            ...
                            LoginTimesaveData loginTimesaveData = new LoginTimesaveData(
                                    ...
                                    ConstantString.CLIENT_LOGIN
                            );
                            Log.d(TAG, "vollyPostRequest: " + jsonObject.getString(ConstantString.RESPONSE_SUCCESS));

                            /**QuickBlox signup*/
                            signup_quickblox(fullname, email, successresponse.getString(ConstantString.ID), loginTimesaveData);
...
//            showvaldationError(getResources().getString(R.string.errorphoneno), R.raw.questionmark);
    ...
    private void showvaldationError(String msg, int resco) {
        BottomSheet_for_error bottomSheet_for_error = new BottomSheet_for_error(msg, resco);
...
//    signup_quickblox(fullname,email,password,successresponse.getString(ConstantString.ID));
    ...
    private void signup_quickblox(String fullname, String email,
        ...
        Log.e(TAG, "signup_quickblox: fullname-> "+fullname+" email-> "+email+" id -> "+id );
        ...
        Log.e(TAG, "signup_quickblox:---> "+qbUserm );
//        SharedPreferanceManager.getInstance(this).removeQbUser();
        ...
        QBUsers.signUp(qbUserm).performAsync(new QBEntityCallback<QBUser>() {
            ...
            public void onSuccess(QBUser qbUser, Bundle bundle) {
                Log.e(TAG, "onSuccess: ---> "+qbUser );
                Toast.makeText(Clients_SignUpActivity.this, "signup successfully ", Toast.LENGTH_SHORT).show();
                signinbtn.setText(R.string.letgo);
            ...
            public void onError(QBResponseException e) {
                enableView();
                Toast.makeText(Clients_SignUpActivity.this, "signup -> "+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void goToHome(LoginTimesaveData loginTimesaveData, String id,QBUser qbUser) {
        ...
        Log.e("checkuser", "goToHome: "+qbUser );
        Intent intent = new Intent(Clients_SignUpActivity.this,
                Clients_CreateAccount.class);
        intent.putExtra("logintimesaveData", loginTimesaveData);
