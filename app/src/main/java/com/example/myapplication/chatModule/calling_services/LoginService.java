    ...
    private void sendResultToActivity(boolean isSuccess, String errorMessage) {
        if (pendingIntent != null) {
            ...
            try {
                ...
                intent.putExtra(ConstantString.EXTRA_LOGIN_RESULT, isSuccess);
                intent.putExtra(ConstantString.EXTRA_LOGIN_ERROR_MESSAGE, errorMessage);

                pendingIntent.send(LoginService.this, ConstantString.EXTRA_LOGIN_RESULT_CODE, intent);
                stopForeground(true);
