...
public class videoService extends Service implements QBRTCClientSessionCallbacks {
...
//                makeCall();
    ...
    public void startMyOwnForeground() {
        ...
        Notification notification = notificationBuilder.setOngoing(true)
                ...
                .setContentTitle("Video call with "+serviceIntent.getStringExtra("username")+" is running.")
        ...
        QBChatService.getInstance().getVideoChatWebRTCSignalingManager()
                .addSignalingManagerListener(new QBVideoChatSignalingManagerListener() {
                    ...
                    public void signalingCreated(QBSignaling qbSignaling, boolean createdLocally) {
                        if (!createdLocally) {
                            QBRTCClient.getInstance(videoService.this).addSignaling((QBWebRTCSignaling) qbSignaling);
                        }
                    }
                });
    }
